function [] = plot_outflow_info( h, P, x_hat, T_FINAL, p2, q_c, sigma2_d_4, sigma2_d_5 )
%PLOT_ESTIMATION_ERROR Plots the estimation error for 3 signals.

    value_string = strcat( ' d_4 var = ', num2str(sigma2_d_4) , ' d_5 var = ', num2str(sigma2_d_5), ' q_{out} init mu = ', num2str(x_hat(5,1)), ' var = ', num2str(P(5,5,1)) );
    save_string = strcat( ' Part2_q_c_',num2str(q_c),'_d_4_', num2str(sigma2_d_4) ,'_d_5_', num2str(sigma2_d_5) , '_q_out_init_mu_', num2str(x_hat(5,1)), '_var_', num2str(P(5,5,1)) );
    ...
    legend('Actual q_c', 'Estimated q_c', 'Estimated q_c_2' )
