...
for t = 1:T_FINAL
    [y(t), h(:,:,t+1)] = simulate_nonlinear_system( F, G, H, W, h(:,:,t), input(t), mu, sigma_d, sigma_w );
    
    [x_hat_pred(:,:,t+1), P_pred(:,:,t+1), y_hat_pred(:,:,t), K_pred(:,:,t)] = extended_kalman(F,G,H,W,V,input(t),y(t),x_hat_pred(:,:,t),P_pred(:,:,t));
...
% COMPARING
plot_estimation_error(h, y, x_hat_pred, T_FINAL, p3, 'Extended KF')
