...
h3_final = h(3,1,T_FINAL)
var3 =  P_pred(3,3,T_FINAL)
sd3 = sqrt(var3)
confHigh = h3_final + 2*sd3
confLow = h3_final - 2*sd3


%%
% Check the system N times to check our prediction
ITER_LENGTH = 1000;
final_h = zeros(3,1,ITER_LENGTH);
