...
% Plot Input and how the system evolves 
plot_system( h, y, T_FINAL, input, z1, p3 )

% Plot how Kalman Filter performs
plot_estimation_error(h, y, x_hat_pred, T_FINAL, p3, ' Predictor Form', 'Part1_c_K_PF_comparison')
plot_estimation_error(h, y, x_hat_FF, T_FINAL, p3, ' Filter Form', 'Part1_c_K_FF_comparison')
plot_estimation_error(h, y, x_hat_inv, T_FINAL, p3, ' Time-Invariant Form Form', 'Part1_c_K_TI_comparison')

% Plot Kalman Gain
plot_kalman_gain(K_pred, T_FINAL, ' Predictor Form', 'Part1_c_K_PF_gain');
plot_kalman_gain(K_FF, T_FINAL,' Filter Form', 'Part1_c_K_FF_gain');


% Plot Squared Estimation Error
plot_squared_estimation_error(x_hat_pred, h, T_FINAL, ' Predictor Form', 'Part1_c_K_PF_squared_error');
plot_squared_estimation_error(x_hat_FF, h, T_FINAL,' Filter Form', 'Part1_c_K_FF_squared_error');
plot_squared_estimation_error(x_hat_inv, h, T_FINAL,' Time Invariant Form', 'Part1_c_K_TI_squared_error');
